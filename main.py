...
if name:
    ...
    user_city = st.text_input("From which city are you using the app?")
    if user_city:
        user_local_time, user_UTC_offset = get_city_local_time(user_city)
    ...
    if city:
        city_local_time, city_UTC_offset = get_city_local_time(city)
